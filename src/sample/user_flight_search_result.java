...
public class user_flight_search_result implements Initializable {

    @FXML
    private AnchorPane container;
    AnchorPane search_result,pay,updateprofile,flightsearch,userinfo;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            search_result = FXMLLoader.load(getClass().getResource("Search_Result.fxml"));

        } catch (IOException ex) {
            Logger.getLogger(UserPanelController.class.getName()).log(Level.SEVERE, null, ex);
        }

        setNode(search_result);
